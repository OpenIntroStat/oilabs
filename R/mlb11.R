...
#'       how often a batter reaches base for any reason other than a fielding 
#'       error, fielder's choice, dropped/uncaught third strike, fielder's 
#'       obstruction, or catcher's interference.}
...
#'   \item{new_obs}{Newer variable: on-base plus slugging, calculated as the 
#'   sum of the on-base and slugging percentages.}
#' }
